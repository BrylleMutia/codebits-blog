      ...
      <Card className={classes.root} style={cardDisplayStyle()}>
          ...
          <CardActionArea>
            {isLoading ? (
              ...
              <React.Fragment>
                ...
                <div className={card__rating}>{parseInt(averageRating) === averageRating ? `${averageRating}.0` : averageRating.toPrecision(2)}</div>
              </React.Fragment>
            )}
        ...
        <CardActions className={classes.actions}>
          ...
          <div className={classes.icons}>
            ...
            {/* ONLY SHOW DELETE POST BUTTON FOR ADMIN OR AUTHOR */}
            {(user.name === author || user.email === "bryllemutia3@gmail.com") && (
