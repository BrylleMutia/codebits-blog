...
import { modalImg } from "./RegisterModal.module.css";
...
function RegisterModal({ history, toggleMenu }) {
    ...
    useEffect(() => {
        ...
        if (isRegisterModalOpen && isAuthenticated) handleRegisterModalToggle();
    ...
    return (
        <div className={classes.container}>
            <Button variant="contained" size="small" color="primary" onClick={handleRegisterModalToggle}>
                Register
            </Button>
